...
public class WebConfig implements WebMvcConfigurer  {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        ...
        registry.addMapping("/api/auth/**").allowedOrigins("http://localhost:3000", "http://localhost:5000", "https://lportalclient.herokuapp.com").allowedMethods("PUT", "POST", "GET", "DELETE");
